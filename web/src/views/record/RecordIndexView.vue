        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr v-for="record in records" :key="record.record.id">
                    ...
                    <td>
                        <button type="button" @click ="open_record_content(record.record.id)" class="btn btn-secondary">Replay</button>
...
export default{
    ...
    setup(){
        ...
        const pull_page =  page =>{
            current_page = page;
            $.ajax({
            url:"https://app5070.acapp.acwing.com.cn/api/record/getlist/",
            type : "get",
            data : {
                page,
            },
        ...
        // parse string to a 2d map array
